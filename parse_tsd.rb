...
#      "0x%04X" % h[:tareZ],
      ...
      "0x%04X%04X" % h[:fftRank][0].values,
      "0x%04X%04X" % h[:fftRank][1].values,
      "0x%04X%04X" % h[:fftRank][2].values,
      "0x%04X%04X" % h[:fftRank][3].values,
      "0x%04X%04X" % h[:fftRank][4].values,
      "0x%04X%04X" % h[:fftRank][5].values,
      "0x%04X%04X" % h[:fftRank][6].values,
      "0x%04X%04X" % h[:fftRank][7].values,
      "0x%04X%04X" % h[:fftRank][8].values,
      "0x%04X%04X" % h[:fftRank][9].values,
